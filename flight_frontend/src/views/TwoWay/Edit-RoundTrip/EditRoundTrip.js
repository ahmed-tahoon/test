...
- IST </h5>
    ...
    <div className='' >
      <div className='d-flex justify-content-center align-items-center flex-column'>
        <p className='text-nowrap'>Inscrease / descrease Price</p>
      </div>
            <div className='d-flex justify-content-end align-items-center mb-2 ' style={{ marginRight: "32px" }}>
              ...
              <input
                className='text-center rounded textinputround'
                onChange={handelchangecount}
                style={{ width: "90px", backgroundColor: "#D6DCE5" }}
                type="number"
                min="0"
                oninput={(e) => {
                  ...
                  if (e.target.value < 0) {
                    alert("The value must be greater than or equal to 0.");
                  }
                }} />
