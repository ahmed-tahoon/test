...
const FilterFlight = ({title,tableData,settableData}) => {
  ...
  const handelFilter = () => {
    if (title === "Country") {
      if (checked && GetcountryData && checkedItems) {
        ...
        for (let i = 0; i < checkedItems.length; i++) {
          const update = tableData?.filter((item) => {
            return item?.country?.name === checkedItems[i];
          });
    ...
    if (title === "City") {
      if (checked && GetCityData && checkedItems) {
        ...
        for (let i = 0; i < checkedItems.length; i++) {
          const updatecity = tableData?.filter((item) => {
            return item?.city?.name === checkedItems[i];
          });
    ...
    if (title === "AirLines") {
      if (checked && GetflightCompanyData && checkedItems) {
        ...
        for (let i = 0; i < checkedItems.length; i++) {
          const updatecity = tableData?.filter((item) => {
            return item?.company?.name === checkedItems[i];
          });
      ...
      if (ceckedsortZtoA) {
        const update = [...tableData];
        update.sort((a, b) => a.company.name.localeCompare(b.company.name));
        settableData(update);
        setcheckData(update);
      }
    ...
    if (title === "Flight No.") {
      if (checked && flightNo && checkedItems) {
        ...
        for (let i = 0; i < checkedItems.length; i++) {
          const updatecity = tableData?.filter((item) => {
            return item?.flight_number === checkedItems[i];
          });
    ...
    if (title === "Arr.APT") {
      if (checked && GetdapartureData && checkedItems) {
        ...
        for (let i = 0; i < checkedItems.length; i++) {
          const update = tableData?.filter((item) => {
            return item?.arrival_airport === checkedItems[i];
          });
    ...
    if (title === "Dep.APT") {
      if (checked && GetdapartureData && checkedItems) {
        ...
        for (let i = 0; i < checkedItems.length; i++) {
          const update = tableData?.filter((item) => {
            return item?.departure_airport?.name === checkedItems[i];
          });
      ...
      if (ceckedsortZtoA) {
        const update = [...tableData];
        update.sort((a, b) =>
          a.departure_airport?.name.localeCompare(b.departure_airport?.name)
        );
        settableData(update);
        setcheckData(update);
      }
