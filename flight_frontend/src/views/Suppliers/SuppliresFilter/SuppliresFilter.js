...
const SuppliresFilter = ({title,tableData,settableData}) => {
...
useEffect(()=>{
  if(title === "Dep.APT" ||title === "Airport Name" ){
...
useEffect(()=>{
  if(title === "Arr.APT" ||title === "Airport Name"){
      setdata(GetdapartureData)
  }
},[title,GetdapartureData])
...
const handelFilter = ()=>{
  ...
  if(title === "Country" ){
    ...
    if(ceckedsortZtoA){
      ...
      update.sort((a, b) => a.country.localeCompare(b.country));
      settableData(update)
      setcheckData(update)
    ...
    if(ceckedsortAtoZ){
      ...
      update.sort((b, a) => b.country.localeCompare(a.country));
      update.reverse()
      settableData(update)
      setcheckData(update)
  ...
  if(title === "City"  ){
    ...
    if(ceckedsortZtoA){
      ...
      update.sort((a, b) => a.city.localeCompare(b.city));
      settableData(update)
      setcheckData(update)
    ...
    if(ceckedsortAtoZ){
      ...
      update.sort((b, a) => b.city.localeCompare(a.city));
      update.reverse()
      settableData(update)
      setcheckData(update)
  ...
  if(title === "AirLines"  ){
    ...
    if(ceckedsortZtoA){
      ...
      update.sort((a, b) => a.airline_name.localeCompare(b.airline_name));
      settableData(update)
      setcheckData(update)
    ...
    if(ceckedsortAtoZ){
      ...
      update.sort((b, a) => b.airline_name.localeCompare(a.airline_name));
      update.reverse()
      settableData(update)
      setcheckData(update)
  ...
  if(title === "Airport Name" || title === "Dep.APT"|| title === "Arr.APT"){
    ...
    if(ceckedsortZtoA){
      ...
      update.sort((a, b) => a.airport_name.localeCompare(b.airport_name));
      settableData(update)
      setcheckData(update)
    ...
    if(ceckedsortAtoZ){
      ...
      update.sort((b, a) => b.airport_name.localeCompare(a.airport_name));
      update.reverse()
      settableData(update)
      setcheckData(update)
...
export default SuppliresFilter
